...
WHERE LUONGMIN BETWEEN 95000 AND 130000
...
SELECT TOP 1 MANV, HOTENNV, LCB,TENPB
...
WHERE NOT EXISTS (SELECT MAPB,TENPB FROM NHANVIEN        
...
INSERT INTO NHANVIEN VALUES
        ('NV04',N'TRẦN HOÀNG ÁNH',5000000,'08-08-1977',N'NAM','CV02','KT')
